...
<head>
<meta charset="UTF-8">
<title>Student Attendence Details</title>
...
<table class="table table-hover table-sm" border="5px">
			...
			<tr>
			<th>Student Id</th>
			<th>No of classess conducted</th>
			<th>No of classess Attended</th>
...
<%
	...
	try{
		...
		PreparedStatement pst = con.prepareStatement("select * from attendence where SID=?");
		pst.setInt(1, id);
