...
<title>Menu</title>
  ...
  <a href="Course.jsp"> <button  class="btn btn-secondary btn-lg"><i class="fa fa-book" aria-hidden="true"></i>Course Details</button></a>
  ...
  <a href="Education.jsp" ><button type="button" class="btn btn-warning btn-lg"><i class="fa fa-graduation-cap" aria-hidden="true"></i>Education Details</button></a>
   ...
   <br>
   <br>
   <a href="Subjects.jsp"><button type="button" class="btn btn-danger btn-lg"><i class="fa fa-inbox"></i>Subject Details</button></a>
